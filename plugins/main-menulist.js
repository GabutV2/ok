...
//------------------ DOCUMENT
await conn.send3ButtonImg(m.chat, await (await fetch('https://i.ibb.co/WzLBSqb/jnck.jpg')).buffer(), cap1, text.trim(), 'OWNER', '.owner', 'SEWA BOT', '.sewa', 'S & K', '.rules',  m, {
      quoted: fliveLoc,  
 ...
              description: syt,
              mediaType: 1,  
            thumbnail: await (await fetch('https://i.ibb.co/WzLBSqb/jnck.jpg')).buffer(),
           sourceUrl: syt
          }  
       }  
      })
